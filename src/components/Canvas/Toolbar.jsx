...
const Toolbar = ({ activeTool, setActiveTool, onAddShape, onAddNote, onAddText, selectedColor, onColorChange, showIconPalette, onToggleIconPalette, onAnimateAll, isAnimating = false }) => {
    const toolSections = [
        {
            label: 'General',
            tools: [
